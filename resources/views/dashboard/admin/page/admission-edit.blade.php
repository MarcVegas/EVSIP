...
<div class="thirteen wide column" style="padding: 0 !important;">
    ...
    <div class="pale" style="margin-top: 1em; height: 41em;">
        ...
        <div class="ui basic segment">
            <h2 style="color: #434a77;"><i class="clipboard list icon"></i> Edit enrollee requirements</h2>
            <div class="ui stackable grid">
                <div class="nine wide column">
                    <div class="ui basic very padded segment">
                        <form class="ui form" action="{!! action('AdmissionController@update', $admit->id) !!}" method="POST">
                            @csrf
                            <div class="field">
                                ...
                                <select class="ui dropdown" name="enrolee_type" id="enrolee_type">
                                    ...
                                    @foreach (Cache::get('enrolee') as $enrolee)
                                        <option value="{{ $enrolee }}"{{ ( $admit->enrolee_type == $enrolee ) ? ' selected' : '' }}>{{ $enrolee }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="field">
